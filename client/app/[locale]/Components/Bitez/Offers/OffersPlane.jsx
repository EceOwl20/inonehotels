...
const OffersPlane = () => {
  ...
  return (
    <div className='flex flex-col mt-6 lg:mt-12 py-6 lg:py-12 px-4 sm:px-6 lg:px-8 -mb-24 bg-white'>
      {/* Title - responsive positioning */}
      <div className='flex justify-center lg:justify-start lg:ml-48 mb-6 lg:mb-8'>
        <h2 className='text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-800 mb-4 text-center lg:text-left'>
